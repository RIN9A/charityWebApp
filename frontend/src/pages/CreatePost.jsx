...
export default function CreatePost() {
  ...
  return (
    <div className="p-3 max-3xl mx-auto min-h-screen">
        <h1 className="text-center text-3xl my-7 font-semibold">Создать запись</h1>
        <form className="   flex flex-col gap-4 max-w mx-auto " onSubmit={handleSubmit}>
        <div class="  border border-blue-700  rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-yellow-700">
            ...
            <div className="flex gap-4 items-center justify-between border-4 border-blue-500 border-dotted p-3 mb-4">
                <FileInput 
                type='file' 
                accept="image/*" 
